...
public class Question1 {
	...
	public static void main(String[] args) {
		...
		List<Transcation> transactionList = getAllTransactions();


		
		System.out.println("---------------------------------1. Find all transactions in the year 2011 and sort them by value (small to high)---------------------------------");
		List<Transcation> listAllTransactionsInTheYear2011 = transactionList.stream()
		...
		List<Transcation> transactionWithSmallestValue = transactionList.stream()
												.limit(1)
												.sorted((Transcation o1, Transcation o2) ->  Integer.compare(o1.getValue(), o2.getValue()))
												.collect(Collectors.toList());
	...
	private static List<Transcation> getAllTransactions() {
		...
		List<Transcation> transactions = Arrays.asList(new Transcation(ram, 2011, 300),
				new Transcation(ram, 2012, 1000), new Transcation(kapil, 2011, 400), new Transcation(raj, 2012, 710),
				new Transcation(ekta, 2012, 700), new Transcation(ekta, 2012, 950));
